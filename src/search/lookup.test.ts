...
describe("dictionary search", () => {
  beforeEach(async () => {
    ...
    await db.senses.bulkPut([
      { id: "s-saw-tool", entryId: "e-saw", packId: "p", pos: "noun", ipa: "/sɔː/", pronunciationId: "p-saw", glossEn: "tool", glossTc: "鋸", usageNote: null, domains: ["everyday"], examples: [], synonyms: [], synonymStatus: "none-appropriate", collocations: [], frequency: { form: "saw", zipf: 5.34, commonness: 74, source: "wordfreq", sourceVersion: "3.1.1", scaleVersion: "v1", status: "measured" }, selection: "learn" },
      { id: "s-see-past", entryId: "e-see", packId: "p", pos: "verb", ipa: "/sɔː/", pronunciationId: "p-saw", glossEn: "past of see", glossTc: "看見", usageNote: null, domains: ["everyday"], examples: [], synonyms: [], synonymStatus: "none-appropriate", collocations: [], frequency: { form: "saw", zipf: 5.34, commonness: 74, source: "wordfreq", sourceVersion: "3.1.1", scaleVersion: "v1", status: "measured" }, selection: "learn" },
      { id: "s-streamline", entryId: "e-streamline", packId: "p", pos: "verb", ipa: "/ˈstriːmlaɪn/", pronunciationId: "p-streamline", glossEn: "simplify a process", glossTc: "精簡", usageNote: null, domains: ["business"], examples: [], synonyms: [], synonymStatus: "authored", collocations: [], frequency: { form: "streamline", zipf: 3.18, commonness: 26, source: "wordfreq", sourceVersion: "3.1.1", scaleVersion: "v1", status: "measured" }, selection: "learn" },
    ]);
